...
function ax = plot_kpi(x_axs, kpi_mean, kpi_std, name_1, i_1, n_1, speeds, i_spe, colors, linestyles)
    ...
    controller_name = string(name_1(i_1));
    if controller_name == "dynamic_gaits"
        controller_name = "dynamic gaits";
    end

    display_name = controller_name + " — " + string(speeds(i_spe)) + " m/s";
    ...
    title("Cost of Transport (Electrical Energy Usage)")
